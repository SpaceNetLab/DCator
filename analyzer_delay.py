...
def optimize_with_gurobi(sat_pos_cbf, dis, initial_guess, timelimit, ue_num):
    ...
    model.setParam('FeasibilityTol', 0.01)  # 可行解的精度限制 最小1e-9 
...
def get_pos(trace_file, est_ue_loc_file, ue_pos, ue_pos_cbf, bound, timelimit, ue_num):

    dis, sat_pos_cbf = init_paras(trace_file, bound)
...
if __name__ == "__main__":
    ...
    trace_file = 'examples/trace_delay.csv'
    est_ue_loc_file = 'examples/result_delay.csv'
